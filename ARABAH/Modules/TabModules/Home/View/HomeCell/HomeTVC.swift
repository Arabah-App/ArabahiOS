...
extension HomeTVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0: // Banner
            ...
            if !isLoading {
                let imageIndex = imageURL + (banner?[indexPath.row].image ?? "")
        ...
        case 1: // Categories
            ...
            if !isLoading {
                ...
                let catImageIndex = imageURL + (category?[indexPath.row].image ?? "")
        ...
        default: // Latest products
            ...
            if !isLoading {
                ...
                let latProdImgIndex = imageURL + (latProduct?[indexPath.row].image ?? "")
