...
final class ReportViewModelTests: XCTestCase {
    ...
    func testStateTransitionsFromIdleToLoadingToSuccess() {
        ...
        // Act
        viewModel.reportAPI(with: .init(productID: "123", message: "Valid message"))
    ...
    func testStateDoesNotBecomeLoadingWhenValidationFails() {
        ...
        // Act
        viewModel.reportAPI(with: .init(productID: "123", message: "   ")) // invalid (only whitespace)
    ...
    func testConsecutiveValidCallsEmitIndependentStates() {
        ...
        // Act
        viewModel.reportAPI(with: .init(productID: "1", message: "First"))
        viewModel.reportAPI(with: .init(productID: "2", message: "Second"))
    ...
    func testValidationErrorMessage() {
        ...
        // Act
        viewModel.reportAPI(with: .init(productID: "abc", message: ""))
