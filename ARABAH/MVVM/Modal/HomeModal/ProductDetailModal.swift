...
struct ProductDetailModal: Codable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(ProductDetailModalBody.self, forKey: .body)
    }
}
...
struct ProductDetailModalBody: Codable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        self.averageRating = try container.decodeIfPresent(Int.self, forKey: .averageRating)
